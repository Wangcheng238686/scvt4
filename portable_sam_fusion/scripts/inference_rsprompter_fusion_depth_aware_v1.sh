...
CHECKPOINT_PATH="${CHECKPOINT_PATH:-/home/wangcheng/project/SCVT3/portable_sam_fusion/checkpoints/rsprompter-fusion-satS-depth-aware-v1/best_model.pth}"
CONFIG_PATH="${PROJECT_ROOT}/configs/rsprompter_anchor_satS_drone_depth_aware_v1.py"
INFERENCE_BIN="${PROJECT_ROOT}/inference/inference_rsprompter_fusion.py"

TIMESTAMP=$(date +"%Y%m%d_%H%M%S")
SHOW_DIR="${PROJECT_ROOT}/inference_results/vis_depth_aware_${TIMESTAMP}"
WORK_DIR="${PROJECT_ROOT}/inference_results/metrics_depth_aware_${TIMESTAMP}"
...
echo "========================================"
echo "开始 RSPrompter(SAM) 深度感知BEV融合推理与可视化"
echo "========================================"
echo "配置: $CONFIG_PATH"
