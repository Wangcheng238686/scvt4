...
CHECKPOINT_DIR="${CHECKPOINT_DIR:-${PROJECT_ROOT}/checkpoints/rsprompter-fusion-satS-depth-aware-v1}"
...
LOG_FILE="${LOG_DIR}/rsprompter_fusion_depth_aware_v1_${TIMESTAMP}.log"
mkdir -p "$LOG_DIR"
ln -sf "$LOG_FILE" "${LOG_DIR}/rsprompter_fusion_latest_depth_aware_v1.log"
...
echo "========================================"
echo "RSPrompter(SAM) 卫星主分支(S) - 深度感知BEV融合训练"
echo "========================================"
echo "训练参数:"
echo "  - 总轮数: $EPOCHS"
...
echo ""
echo "========================================"
echo "RSPrompter(SAM) 深度感知BEV融合训练完成"
echo "========================================"
