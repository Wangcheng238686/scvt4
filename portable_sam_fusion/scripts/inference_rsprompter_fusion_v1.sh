...
CHECKPOINT_PATH="${CHECKPOINT_PATH:-/home/wangcheng/project/SCVT3/portable_sam_fusion/checkpoints/rsprompter-fusion-satS-v1/best_model.pth}"
...
SHOW_DIR="${PROJECT_ROOT}/inference_results/vis_${TIMESTAMP}"
WORK_DIR="${PROJECT_ROOT}/inference_results/metrics_${TIMESTAMP}"
...
echo "========================================"
echo "开始 RSPrompter(SAM) 融合推理与可视化"
echo "========================================"
echo "配置: $CONFIG_PATH"
