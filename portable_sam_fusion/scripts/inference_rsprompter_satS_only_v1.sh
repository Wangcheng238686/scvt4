...
CHECKPOINT_PATH="${CHECKPOINT_PATH:-/home/wangcheng/project/SCVT3/portable_sam_fusion/checkpoints/rsprompter-satS-only-v1/best_model.pth}"
...
SHOW_DIR="${PROJECT_ROOT}/inference_results/vis_satS_only_${TIMESTAMP}"
WORK_DIR="${PROJECT_ROOT}/inference_results/metrics_satS_only_${TIMESTAMP}"
...
echo "========================================"
echo "RSPrompter(SAM) 卫星单分支推理 (消融实验)"
echo "========================================"
echo "配置: $CONFIG_PATH"
