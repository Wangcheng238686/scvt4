...
work_dir = os.environ.get("WORK_DIR", "./work_dirs/portable_sam_fusion/rsprompter_anchor_satS_drone_depth_aware_v1")
...
depth_pretrained_path = os.environ.get(
    "DEPTH_ANYTHING_V2_CKPT",
    os.path.abspath(os.path.join("pretrained", "depth_anything_v2_vits.pth")),
)
