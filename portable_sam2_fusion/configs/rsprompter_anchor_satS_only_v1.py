...
work_dir = os.environ.get("WORK_DIR", "./work_dirs/portable_sam_fusion/rsprompter_anchor_satS_only_v1")
...
model = dict(
    ...
    shared_image_embedding=dict(
        ...
        extra_config=dict(image_size=512),
    ...
    backbone=dict(
        ...
        hf_pretrain_name=hf_sam_pretrain_name,
        extra_config=dict(output_hidden_states=True, image_size=512),
        init_cfg=dict(type="Pretrained", checkpoint=hf_sam_pretrain_ckpt_path),
        use_offline_mode=True,
